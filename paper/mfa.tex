...
\begin{subfigure}[]{}
  ...
  \label{fig:eigvect2}
\end{subfigure}
\caption{  \label{fig:eigvect} Hessian eigenvectors for the two hidden layer bwtwork trained on the linear (top) and non-linear (bottom) classification task. The bar indicates the value of the eigenvector coefficients.}
\end{figure*}
