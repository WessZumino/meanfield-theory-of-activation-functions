...
\icmltitlerunning{Submission and Formatting Instructions for ICML 2019 Workshop on Theoretical Physics for Deep Learning}
...
\icmltitle{Submission and Formatting Instructions for
           the ICML Workshop \\ on Theoretical Physics for Deep Learning (ICML Phys4DL 2019)}
...
Submission to \textit{ICML 2019 workshop on Theoretical Physics for Deep Learning} will be entirely electronic.%, via a web site (not email). 
Information about the submission process and \LaTeX\ templates
are available on the workshop web site:
\begin{center}
\textbf{\texttt{\url{https://sites.google.com/view/icml2019phys4dl}}}
\end{center}
...
\item Submitted papers can be up to four pages long, not including references, acknowledgements and supplementary material. %and up to twelve pages when references and acknowledgments are included. Any paper exceeding this length will automatically be rejected.
% \item \textbf{Do not include author information or acknowledgements} in your initial submission.
...
submission does not reach us on time, it will not be
...
%have shown \ldots'').
%
%Do not anonymize citations in the reference section. 
%The only exception are manuscripts that are
